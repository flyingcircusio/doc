...
Customer-owned virtual machines may be accessed by all Flying Circus administrators implicitly. Within the scope of specific projects additional Flying Circus staff (e.g. support staff) may get explicit access. Access by others (e.g., customer personnel, third parties) must be authorised by a client representative.
