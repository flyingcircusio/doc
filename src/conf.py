# -*- coding: utf-8 -*-
#
# Flying Circus documentation build configuration file, created by
# sphinx-quickstart on Thu Dec  3 14:25:50 2009.
#
...
if os.environ.get("version", "0.0000000") != "0.0000000":
    ...
    release = "{} ({})".format(os.environ["version"], os.environ.get("gitTag"))
else:
    isodate = (
        subprocess.Popen(
            "git show --format=format:\%cI", shell=True, stdout=subprocess.PIPE
        )
        .communicate()[0]
        .decode("utf-8")
        .splitlines()[0]
...
feed_author = (
    "Flying Circus Internet Operations GmbH <support@flyingcircus.io>"
)
